...
- (EGMutableDictionary*) enterRoomImplementation:(EGRoomOptions*)options :(NSDictionary*)customLocalPlayerProperties;
...
{
	return [self opJoinRandomRoom:customRoomProperties :maxPlayers :ExitGames::LoadBalancing::MatchmakingMode::FILL_ROOM];
}
...
{
    return [self opJoinRandomRoom:customRoomProperties :maxPlayers :matchmakingMode :lobbyName :ExitGames::LoadBalancing::LobbyType::DEFAULT];
}
