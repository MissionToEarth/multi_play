...
- (id) copyWithZone:(NSZone*)zone
{
	...
	EGLoadBalancingMutableRoom* retVal = [[[self class] alloc] initLoadBalancingRoom:self.Name :props :mLoadBalancingClient :self.PropsListedInLobby :self.PlayerTtl :self.EmptyRoomTtl];
